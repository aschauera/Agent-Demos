...
namespace VoiceAgentSample
{
    ...
    public class BotService : IBotService
    {
        ...
        public string DirectLineBaseUri { get; set; }
        ...
        public async Task<string> GetTokenAsync()
        {
            ...
            {
                throw new TaskCanceledException($"Exception caught: directline failed to create token with token endpoint url: {TokenEndPoint}, {ex.Message}");
            }
